...
const enMessages = {
    ...
    errorTitle: '❌ Error',
    operationFailedTryAgain: 'The operation failed. Please try again later.',
    pleaseRunInServer: 'Please run this command in a server.',
    couldNotRetrieveRoleInfo: 'Could not retrieve role information. Please try again in the server where this command was used.',
    noPermissionManageGiveaways: 'You do not have permission to manage giveaways. Ask a server owner to grant the required role.',
...
const jaMessages = {
    ...
    errorTitle: '❌ エラー',
    operationFailedTryAgain: '操作に失敗しました。時間をおいて再試行してください。',
    pleaseRunInServer: 'このコマンドはサーバー内で実行してください。',
    couldNotRetrieveRoleInfo: 'ロール情報を取得できませんでした。コマンドを実行したサーバーで再度お試しください。',
    noPermissionManageGiveaways: '抽選を管理する権限がありません。サーバーオーナーに必要なロール付与を依頼してください。',
